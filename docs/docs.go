...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/audit/entity/{entity_type}/{entity_id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Entity type (user, group, network)",
                        "name": "entity_type",
                        "in": "path",
                        "required": true
                    },
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.NetworkResponse"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.AddNetworkToGroupRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/groups/{id}/networks/{network_id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.NetworkListResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateNetworkRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateNetworkRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.AddGroupToNetworkRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/networks/{id}/groups/{group_id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.UserGroupsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.AddUserGroupRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.VpnSessionListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/vpn/sessions/{id}/disconnect": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.VpnUsageStats"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.VpnTrafficStatsListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateVpnTrafficStatsRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/dto.VpnTrafficStatsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "dto.CreateNetworkRequest": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Main office network segment"
                },
                "name": {
                    "type": "string",
        ...
        "dto.CreateVpnTrafficStatsRequest": {
            "type": "object",
            "required": [
                "session_id",
                "timestamp"
        ...
        "dto.UpdateVpnSessionRequest": {
            ...
            "properties": {
                ...
                "disconnect_reason": {
                    "$ref": "#/definitions/models.DisconnectReason"
                },
                "disconnected_at": {
                    "type": "string"
                }
        ...
        "dto.UserGroupWithNetworks": {
            ...
            "properties": {
                ...
                "networks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.NetworkBasicInfo"
                    }
                }
            }
        },
        "dto.UserGroupsResponse": {
            "type": "object",
            "properties": {
                "groups": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.UserGroupWithNetworks"
                    }
                }
            }
        },
        ...
        "dto.VpnTrafficStatsListResponse": {
            "type": "object",
            "properties": {
                "page": {
                    "type": "integer"
        ...
        "models.DisconnectReason": {
            ...
            "x-enum-varnames": [
                "DisconnectReasonUserRequest",
                "DisconnectReasonTimeout",
                "DisconnectReasonServerShutdown",
                "DisconnectReasonError",
                "DisconnectReasonAdminAction"
            ]
        },
        "models.Role": {
            "type": "string",
